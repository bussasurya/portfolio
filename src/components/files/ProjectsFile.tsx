...
export default function ProjectsFile({ hasBeenOpened }: { hasBeenOpened: boolean }) {
  ...
  const item: Variants = {
    ...
    visible: {
      ...
      transition: {
        duration: 0.2,
        ease: [0.42, 0, 0.58, 1] // ✅ FIXED (no string issue)
      }
    }
  };
          ...
          <motion.div key={idx} variants={item} className="flex flex-col">
            ...
            <div className="flex">
              ...
              <span className="pl-12">
                <span className="text-[#9cdafe]">name:</span>{" "}
                <span className="text-[#ce9178]">"{proj.name}"</span>,
              </span>
            </div>
            ...
            <div className="flex">
              ...
              <span className="pl-12">
                <span className="text-[#9cdafe]">description:</span>{" "}
                <span className="text-[#ce9178]">"{proj.description}"</span>,
              </span>
            </div>
            ...
            <div className="flex text-wrap">
              ...
              <span className="pl-12 flex flex-wrap gap-x-1">
                <span className="text-[#9cdafe]">techStack:</span>{" "}
            ...
            <div className="flex">
              ...
              <span className="pl-12">
                <span className="text-[#9cdafe]">link:</span>{" "}
                <a
                  href={proj.link}
                  target="_blank"
                  rel="noreferrer"
                  className="text-[#ce9178] hover:text-[#4fc1ff] hover:underline underline-offset-2 transition-colors"
                >
                  "{proj.link}"
                </a>
              </span>
            ...
            <div className="flex">
              ...
              <span className="pl-6 text-[#da70d6]">
